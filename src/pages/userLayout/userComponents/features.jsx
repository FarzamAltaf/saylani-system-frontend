...
const featureData = [
    ...
    },
    {
        ...
        description: "Stay ahead of the curve with our cutting-edge features and technologies.",
    },
    {
        icon: <TeamOutlined className="text-4xl text-green-500" />,
        title: "Collaborative Environment",
        description: "Work seamlessly with your team and boost productivity like never before.",
    },
]
